...
@Component({
  selector: 'app-table-editing2',
  templateUrl: './table-editing2.component.html',
  styleUrls: ['./table-editing2.component.css']
})
export class TableEditing2Component implements OnInit {
